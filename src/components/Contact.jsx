  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send( 
        ...
        {
          from_name: form.name,
          to_name: "Hiring Agent Vakil",
          from_email: form.email,
          to_email: "abdulvakil25@gmail.com",
    ...
    >
      ...
      >
        ...
        >
          ...
          <button
            type='submit'
            className='bg-secondary py-3 px-8 rounded-xl outline-none w-fit text-tertiary font-bold shadow-md shadow-tertiary'
          >
